// Source: https://github.com/hannseman/homebridge-mi-hygrothermograph
// Source: https://github.com/eschava/node-red-contrib-xiaomi-ble
...
class Scanner extends EventEmitter {
  ...
  logPeripheral({
    ...
    this.log.info(`[${address || id}] Discovered peripheral
      Id: ${id}
      LocalName: ${localName}
      rssi: ${rssi}
